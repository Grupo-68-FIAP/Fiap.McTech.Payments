...
namespace Fiap.McTech.Payments.BDD.Features
{
...
#line hidden
        ...
        public void Gerar_QRCode_Pagamento()
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Gerar_QRCode_Pagamento", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 3
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 4
  testRunner.Given("que o valor de OrderId é um UUID e que os dados do objeto da requisição sejam fic" +
                        "ticios", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
#line 5
  testRunner.When("eu solicitar para o método GenerateQRCode e passar os parâmetros", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 6
  testRunner.Then("o status de resposta deve ser 200 OK", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
